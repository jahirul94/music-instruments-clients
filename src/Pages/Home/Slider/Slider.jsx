...
const Slider = () => {
    const sliderText = <>
        <div className="absolute rounded-xl h-full left-0 top-0 bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0)]">
            <div className="lg:pt-[300px] px-14 rounded-xl text-white">
        ...
        <div className="mx-4 rounded-xl">
            <Swiper navigation={true} modules={[Navigation]} className="mySwiper">
                <SwiperSlide className="rounded-xl">
                    <div className="min-h-[600px] rounded-xl" style={{ backgroundImage: `url("https://cdn.mos.cms.futurecdn.net/gD3ojQis57J4wJWbeUCgwe.jpg")`, backgroundRepeat: 'no-repeat'}}>
                        <div>
                            {sliderText}
                        </div>
                    </div>
                ...
                <SwiperSlide className="rounded-xl">
                    <div className="min-h-[600px] rounded-xl" style={{ backgroundImage: `url("https://www.musicnotes.com/blog/content/images/2023/03/Acoustic-Guitar-Songs-Beginners.jpg")` , backgroundRepeat:"no-repeat" , backgroundSize:"1500px" }}>
                        <div>
                            {sliderText}
                        </div>
                    </div>
                ...
                <SwiperSlide className="rounded-xl">
                    <div className="h-[600px] rounded-xl" style={{ backgroundImage: `url("https://www.parents.com/thmb/ZRneQeGqThv4iV61Nl25zgQMlhQ=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/GettyImages-96162171-2000-061841fa01cf428bb25fdf405e251907.jpg")` }}>
                        <div>
                            {sliderText}
                        </div>
                    </div>
