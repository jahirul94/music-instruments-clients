    ...
    return (
        <div>
            ...
            <div className={`${theme === "light" ? "text-black" : "text-slate-300"} grid gap-8 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 text-center pb-10 mx-6`}>
                <div className="p-2 border border-slate-300 rounded-lg hover:scale-105 transition-transform duration-500">
                ...
                <div className="border p-2 border-slate-300 rounded-lg hover:scale-105 transition-transform duration-500">
